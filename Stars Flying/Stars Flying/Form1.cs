...
namespace Stars_Flying
{
    public partial class Form1 : Form
    {
        public class Star
        {
            ...
            {
                SolidBrush sld = new SolidBrush(System.Drawing.Color.FromArgb(random.Next(0, 255), random.Next(0, 255), random.Next(0, 255)));
                return sld;
            }
            public Star()
            {
        ...
        {
            float starSize = Map(star.Z, 0, pictureBox1.Width, random.Next(3, 11), 0);
            ...
            graphics.FillEllipse(/*Brushes.RoyalBlue*/star.color, x, y, starSize, starSize);
        }
        //private SolidBrush ColorBrush()
        //{
        //    SolidBrush sld = new SolidBrush(Color.FromArgb(random.Next(0, 255), random.Next(0, 255), random.Next(0, 255)));
        //    return sld;
        //}
